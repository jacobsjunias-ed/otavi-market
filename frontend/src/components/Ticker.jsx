export default function Ticker({ items }) {
  ...
  return (
    <div className="bg-duskdeep border-y border-white/10 overflow-hidden py-2.5">
      <div className="flex gap-10 ticker-track w-max">
        {doubled.map((item, i) => (
          <div key={i} className="flex items-center gap-2 font-mono text-xs whitespace-nowrap text-sand/90">
